...
export const INITIAL_SERVICES = [
  { id: '1', name: 'Consultoria Técnica', defaultPrice: 150 },
  { id: '2', name: 'Manutenção Preventiva', defaultPrice: 80 },
  { id: '3', name: 'Design de Logotipo', defaultPrice: 500 },
  { id: '4', name: 'Aula Particular', defaultPrice: 120 },
];
